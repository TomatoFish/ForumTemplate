...
using ThemeSubscriptionService.AsyncDataServices;
using ThemeSubscriptionService.Data;
using ThemeSubscriptionService.EventProcessing;
using ThemeSubscriptionService.Helpers;
...
builder.Services.AddScoped<IThemeSubscriptionRepo, ThemeSubscriptionRepo>();
